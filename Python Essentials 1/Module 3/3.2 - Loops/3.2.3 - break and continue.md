...
This pattern avoids asking for a number twice before checking the loop condition and ensures that the termination value `-1` can be tested before entering the loop again.
