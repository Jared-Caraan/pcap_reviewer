...
1. The **comparison** (otherwise known as _relational_) operators are used to compare values. The table below illustrates how the comparison operators work, assuming that `x = 0`, `y = 1`, and `z = 0`:
   ...
   <table>
      ...
      <tr>
        ...
        <td><pre>x >= y  # False <br>x >= z  # True <br>y >= z  # True</pre></td>
      </tr>
      <tr>
        <td><code>≤</code></td>
        ...
        <td><pre>x <= y  # True <br>x <= z  # True <br>y <= z  # False</pre></td>
      </tr>
    </table>
